...
sub name_var :Path('/test/') :Args(0) {
	...
	if ($motif == 1){
		$switch++;
			...
			if ($prob_tab == 1 && $line !~ m/^Background\sprobability\smodel/) { 
				...
				#print "gghgsdhgds: $prob_tab_switch\n$line\n";
			...
			if ($BGPM_tab == 1) { 
				...
				#print "gghgsdhgds: $BGPM_tab_switch\n$line\n";
				#print "FREQ LINES: $line\n";
			}
			...
			if ($sum_indv_tab == 1 ) { 
				...
				#print "gghgsdhgds: $sum_indv_tab_switch\n$line\n";
				print "FREQ LINES: $line\n";
			}
	...
	foreach $filename (@motif_table_file){	
		...
		#print "HTML TABLES: $values_motif[0]\n";
	}
	#print "HTML TABLES1: $motif_table_value\n";
